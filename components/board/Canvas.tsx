...
export const Canvas = ({ boardId }: CanvasProps) => {
    ...
    }, [continueDrawing, canvasState, resizeSelectedLayer, camera, translateSelectedLayers, startMultiSelection, updateSelectionNet]);
    ...
    }, [deleteLayers, history, unselectLayers]);
